		...
		<div class="wrapper">
			...
			<div class="header">
				<div class="headerContent">
					<div class="logo"><a href="#"><img src="<?= get_template_directory_uri(); ?>/images/logo.png"></a></div>
				...
				<div id="myCarousel" class="carousel slide">
					<div class="carousel-inner">
						<div class="item active">
							<img src="<?= get_template_directory_uri(); ?>/images/slider-img.jpg" alt="">
						...
						<div class="item">
							<img src="<?= get_template_directory_uri(); ?>/images/slider-img2.jpg" alt="">
							<div class="carousel-caption">
						...
						<div class="item">
							<img src="<?= get_template_directory_uri(); ?>/images/slider-img3.jpg" alt="">
							<div class="carousel-caption">
